-  **v5.3.6** - 2026/03/05 - Fixes avoiding crash of multipoly for exceptional parameters. Fixes in parallax calculation for binary lenses. Fix on quadrupole test failing at some border case.

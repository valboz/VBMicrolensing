-  **v5.4** - 2026/03/06 - Fixes avoiding crash of multipoly for exceptional parameters. Fixes in parallax calculation for binary lenses. Improved test on ghost images.
